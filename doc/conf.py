...
# -*- coding: utf-8 -*-
#
# asynctest documentation build configuration file, created by
# sphinx-quickstart.
#
...
author = copyright = setup_args["author"]
...
texinfo_documents = [(master_doc, project, project + ' Documentation',
